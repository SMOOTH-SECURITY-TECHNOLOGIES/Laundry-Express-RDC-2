...
export const ProfilePage: React.FC = () => {
  ...
  const clientStats = useMemo(() => {
    ...
    return {
      ...
      nextReward: 200,
      referralCode: user?.referralCode || 'LE-DEMO2026',
      referralCount: 4,
      referralPoints: 2000,
      referralRewards: 3,
    };
      ...
      <div className="bg-white rounded-2xl border border-slate-100 p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-[10px] text-slate-400">Notifications actives : <strong className="text-brand-blue">{notifActiveCount}/5</strong></p>
          </div>
        </div>
