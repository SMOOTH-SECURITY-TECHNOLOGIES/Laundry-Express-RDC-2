...
if (-not $env:STAGING_DRIVER_EMAIL) { $env:STAGING_DRIVER_EMAIL = ${env:SEED_DRIVER_EMAIL}; if (-not $env:STAGING_DRIVER_EMAIL) { $env:STAGING_DRIVER_EMAIL = "driver@laundryexpress.cd" } }
if (-not $env:STAGING_DRIVER_PASSWORD) { $env:STAGING_DRIVER_PASSWORD = ${env:SEED_DRIVER_PASSWORD} }
